...
workflow TEMPUS {
    ...
    ch_normal_bai = BWAMEM2_MEM_NORMAL.out.bai
    ...
    ch_tumour_bai = BWAMEM2_MEM_TUMOUR.out.bai

    //
    // MODULE: Run TelomereHunter
    //
    TELOMEREHUNTER_FULL(ch_tumour_bam, ch_tumour_bai, ch_normal_bam, ch_normal_bai, params.banding)
